...
class ThreeInterpolateGPUOp: public OpKernel{
    public:
        ...
        void Compute(OpKernelContext * context) override {
            ...
            OP_REQUIRES(context, points_tensor.dims()==3, errors::InvalidArgument("ThreeInterpolate2 expects (b,m,c) points shape"));
...
REGISTER_KERNEL_BUILDER(Name("ThreeInterpolate2").Device(DEVICE_GPU),ThreeInterpolateGPUOp);
