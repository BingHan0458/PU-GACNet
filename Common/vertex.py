"""
PU-GACNet: Point Cloud upsampling using Graph Attention Convolutional Networks.
"""
...
def ens(x, scale=2, k=20, d=1, channels=64, idx=None, scope='ens', **kwargs):
    """
    Our implementation of ENS upsampling module proposed in PU-GACNet
    """
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        if idx is None:
            idx = dil_knn(x, k, d)
