...
# data
parser.add_argument('--data_dir', default='data/PU1K/test/input_2048')
...
# model
parser.add_argument('--model', default='pugac', help='model name: pugac, pugan, mpu, punet, pugcn')
...
parser.add_argument('--upsampler', default='edge-aware_nodeshuffle', type=str,
                    help="edge-aware_nodeshuffle(ENS), upsampler, multi_cnn, clone, duplicate, nodeshuffle")
...
parser.add_argument('--k_in_gac', type=int, default=1, help='layers of GAC module in feature extraction module')
...
parser.add_argument('--repulse', default=True, action='store_true',
                    help='use repulse loss (default: True)')
...
# test
parser.add_argument("--pred", type=str, help=".xyz")
parser.add_argument("--gt", type=str, help=".xyz")
...
###########################################################################################################
# parameters for GACNet
# graph_inf contents parameters for graph building and coarsing
FLAGS.graph_inf = {'stride_list': [4, 4, 4, 2],  # can be seen as the downsampling rate
...
FLAGS.fullconect_parm = 128

FLAGS.net_inf = {'forward_parm': FLAGS.forward_parm,
                 'upsample_parm': FLAGS.upsample_parm,
                 'fullconect_parm': FLAGS.fullconect_parm
                 }
##########################################################################################################
